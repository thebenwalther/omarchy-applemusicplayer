...
KeyboardPanel {
  ...
  borderSpec: Border.flat(Util.alpha(artworkAccent, 0.42), Math.max(1, Style.space(1)))
      ...
      Flickable {
        ...
        Column {
            ...
            Row {
              ...
              Item {
                ...
                BorderSurface {
                  ...
                  Text {
                    ...
                    RotationAnimation on rotation { from: 0; to: 360; duration: 900; loops: Animation.Infinite; running: currentArtwork.status === Image.Loading }
                  }
                }
              }
              ...
              Column {
                ...
                Row {
                  ...
                  Text { width: parent.width - Style.space(14); text: (root.player && root.player.isPlaying ? "NOW PLAYING · " : "") + root.sourceName.toUpperCase(); color: root.player && root.player.isPlaying ? root.artworkAccent : root.mutedText; font.family: root.bar.fontFamily; font.pixelSize: Style.font.caption; font.bold: true; elide: Text.ElideRight }
                }
          ...
          Row {
            ...
            Button { iconText: "󰒮"; foreground: root.popupText; accent: root.artworkAccent; focusable: true; enabled: root.player && root.player.canGoPrevious; opacity: enabled ? 1 : 0.35; tooltipText: "Previous"; Accessible.name: "Previous"; onClicked: root.actionRequested("previous") }
            Button { text: "−10"; foreground: root.popupText; accent: root.artworkAccent; focusable: true; enabled: root.canSeek; opacity: enabled ? 1 : 0.35; tooltipText: "Back 10 seconds"; Accessible.name: "Back 10 seconds"; onClicked: root.seekRelativeRequested(-10) }
            Button { iconText: root.player && root.player.isPlaying ? "󰏤" : "󰐊"; foreground: root.popupText; accent: root.artworkAccent; background: Util.alpha(root.artworkAccent, 0.2); bordered: true; focusable: true; horizontalPadding: Style.space(17); verticalPadding: Style.space(11); iconSize: Style.font.iconLarge; enabled: root.canToggle; opacity: enabled ? 1 : 0.35; tooltipText: root.player && root.player.isPlaying ? "Pause" : "Play"; Accessible.name: tooltipText; onClicked: root.actionRequested("playPause") }
            Button { text: "+10"; foreground: root.popupText; accent: root.artworkAccent; focusable: true; enabled: root.canSeek; opacity: enabled ? 1 : 0.35; tooltipText: "Forward 10 seconds"; Accessible.name: "Forward 10 seconds"; onClicked: root.seekRelativeRequested(10) }
            Button { iconText: "󰒭"; foreground: root.popupText; accent: root.artworkAccent; focusable: true; enabled: root.player && root.player.canGoNext; opacity: enabled ? 1 : 0.35; tooltipText: "Next"; Accessible.name: "Next"; onClicked: root.actionRequested("next") }
          }
          ...
          Row {
            ...
            Button { text: root.player && root.player.shuffle ? "Shuffle on" : "Shuffle"; iconText: "󰒟"; foreground: root.popupText; accent: root.artworkAccent; focusable: true; selected: root.player && root.player.shuffleSupported && root.player.shuffle; visible: root.modeCapabilities.shuffle; onClicked: root.shuffleRequested() }
            Button { text: root.player && root.player.loopState === MprisLoopState.Track ? "Repeat one" : "Repeat"; iconText: root.player && root.player.loopState === MprisLoopState.Track ? "󰑘" : "󰑖"; foreground: root.popupText; accent: root.artworkAccent; focusable: true; selected: root.player && root.player.loopSupported && root.player.loopState !== MprisLoopState.None; visible: root.modeCapabilities.loop; onClicked: root.loopRequested() }
          }
          ...
          Row {
            ...
            Button { iconText: root.volume <= 0.01 ? "󰝟" : (root.volume < 0.5 ? "󰕿" : "󰕾"); foreground: root.popupText; accent: root.artworkAccent; focusable: true; tooltipText: root.volume <= 0.01 ? "Unmute" : "Mute"; Accessible.name: tooltipText; onClicked: root.muteRequested() }
            PanelSlider { width: parent.width - Style.space(86); bar: root.bar; value: root.volume; minimum: 0; maximum: 1; step: 0.05; fillColor: root.artworkAccent; knobColor: root.popupText; trackColor: Util.alpha(root.popupText, 0.22); Accessible.name: "Volume"; onMoved: function(value) { root.volumeRequested(value) }; onReleased: function(value) { root.volumeRequested(value) }; onRightClicked: root.muteRequested() }
          ...
          Row {
            width: parent.width
            spacing: Style.space(6)
            Button { id: sourceChip; visible: root.sourcePlayers.length > 1; text: root.sourceName; iconText: "󰓃"; foreground: root.popupText; accent: root.artworkAccent; selected: root.sourcesOpen; focusable: true; onClicked: root.sourcesOpen = !root.sourcesOpen }
            Button { id: sleepChip; visible: root.sleepMode !== ""; text: root.sleepLabel; iconText: "󰔛"; foreground: root.popupText; accent: root.artworkAccent; selected: true; focusable: true; onClicked: root.showMore() }
            ...
            Button { id: moreButton; text: "More"; iconText: "󰅂"; foreground: root.popupText; accent: root.artworkAccent; focusable: true; Accessible.name: "More player options"; onClicked: root.showMore() }
          }
          ...
          Row {
            ...
            Button { width: Math.max(1, (parent.width - parent.spacing) * 0.68); text: "Open Apple Music"; iconText: "󰎆"; foreground: root.popupText; accent: root.artworkAccent; background: Util.alpha(root.artworkAccent, 0.14); bordered: true; focusable: true; onClicked: root.openAppleMusicRequested() }
            Button { width: Math.max(1, (parent.width - parent.spacing) * 0.32); text: "Copy"; iconText: "󰆏"; foreground: root.popupText; accent: root.artworkAccent; bordered: true; focusable: true; enabled: root.copyAvailable && root.hasMedia; opacity: enabled ? 1 : 0.35; tooltipText: root.copyAvailable ? "Copy now playing" : "wl-copy is unavailable"; onClicked: root.copyRequested(root.player) }
          }
        }
      }
      ...
      Flickable {
        ...
        Column {
          ...
          Row {
            width: parent.width
            spacing: Style.space(8)
            Button { id: backButton; text: "Back"; iconText: "󰁍"; foreground: root.popupText; accent: root.artworkAccent; focusable: true; Accessible.name: "Back to player"; onClicked: root.showPlayer() }
            Column {
          ...
          Row {
            ...
            Button { text: "Off"; foreground: root.popupText; accent: root.artworkAccent; focusable: true; enabled: root.sleepMode !== ""; opacity: enabled ? 1 : 0.35; onClicked: root.timerCancelRequested() }
          }
          Row {
            width: parent.width
            spacing: Style.space(7)
            ...
            Button { id: minusSleep; iconText: "󰅖"; foreground: root.popupText; accent: root.artworkAccent; focusable: true; enabled: root.customSleepMinutes > 5; tooltipText: "Subtract five minutes"; Accessible.name: tooltipText; onClicked: root.customSleepMinutes = MediaController.clampSleepMinutes(root.customSleepMinutes - 5) }
            Text { id: sleepValue; text: root.customSleepMinutes + "m"; color: root.artworkAccent; font.family: root.bar.fontFamily; font.pixelSize: Style.font.body; font.bold: true; anchors.verticalCenter: parent.verticalCenter }
            Button { id: plusSleep; iconText: "󰐕"; foreground: root.popupText; accent: root.artworkAccent; focusable: true; enabled: root.customSleepMinutes < 180; tooltipText: "Add five minutes"; Accessible.name: tooltipText; onClicked: root.customSleepMinutes = MediaController.clampSleepMinutes(root.customSleepMinutes + 5) }
            Button { id: startSleep; text: "Start"; foreground: root.popupText; accent: root.artworkAccent; bordered: true; focusable: true; onClicked: root.timerMinutesRequested(root.customSleepMinutes) }
          }
          Text { width: parent.width; text: root.sleepMode === "" ? "Audio fades for five seconds before playback pauses." : root.sleepLabel; color: root.sleepMode === "" ? root.mutedText : root.artworkAccent; font.family: root.bar.fontFamily; font.pixelSize: Style.font.caption; wrapMode: Text.WordWrap }
          ...
          Row {
            ...
            Button { id: clearHistoryButton; text: "Clear"; foreground: root.popupText; accent: root.artworkAccent; focusable: true; enabled: root.recentHistory.length > 0; opacity: enabled ? 1 : 0.35; onClicked: root.historyClearRequested() }
          }
          ...
          Toggle { width: parent.width; label: "Artwork colors"; description: "Tint accents from the current album cover."; checked: root.dynamicArtworkColor; foreground: root.popupText; accent: root.artworkAccent; onClicked: root.preferenceRequested("dynamicArtworkColor", !root.dynamicArtworkColor) }
          Toggle { width: parent.width; label: "Bar progress"; description: "Show a thin playback rail under the bar pill."; checked: root.barProgressEnabled; foreground: root.popupText; accent: root.artworkAccent; onClicked: root.preferenceRequested("barProgress", !root.barProgressEnabled) }
          Toggle { width: parent.width; label: "Motion"; description: "Animate artwork, metadata, pages, and progress."; checked: root.motionEnabled; foreground: root.popupText; accent: root.artworkAccent; onClicked: root.preferenceRequested("motionEnabled", !root.motionEnabled) }
          Toggle { width: parent.width; label: "Track-change OSD"; description: "Show title and artist when the song changes."; checked: root.trackChangeOsd; foreground: root.popupText; accent: root.artworkAccent; onClicked: root.preferenceRequested("trackChangeOsd", !root.trackChangeOsd) }
          Toggle { width: parent.width; label: "Session history"; description: "Remember up to ten tracks until the shell restarts."; checked: root.rememberSessionHistory; foreground: root.popupText; accent: root.artworkAccent; onClicked: root.preferenceRequested("rememberSessionHistory", !root.rememberSessionHistory) }

          PanelSeparator { width: parent.width; foreground: root.popupText }
          Button { width: parent.width; text: "Audio Output"; iconText: "󰕾"; foreground: root.popupText; accent: root.artworkAccent; bordered: true; focusable: true; leftAlign: true; tooltipText: "Open Omarchy's native output picker"; onClicked: root.openAudioRequested() }
        }
      }
    }
  }
